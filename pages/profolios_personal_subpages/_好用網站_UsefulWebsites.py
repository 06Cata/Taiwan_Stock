...
def main():
    ...
    LINKS = {
        "TW STOCK": [
            ...
            ("證交所ETF專區", "https://www.twse.com.tw/zh/products/securities/etf/products/list.html", "台股 ETF 資料查詢"),
            ("財報狗 StatementDog", "https://statementdog.com/", "台股美股公司財務與圖表"),
            ("iFa", "https://ifa.ai/tw-stock", "台股公司財務報表"),
            ("GoodInfo! 台灣股市資訊網",
            ...
            "台股籌碼、排行與多維度指標"),
            ("台股買賣超排行", "https://www.wantgoo.com/stock/institutional-investors/foreign/net-buy-sell-rank", "台股買賣超排行"),
            ("類股指數總覽", "https://tw.stock.yahoo.com/sector-index", "台股類股指數漲跌幅"),
            ("漲幅排名", "https://www.wantgoo.com/stock/ranking/top-gainer", "台股漲幅排名"),
            ("台股產業熱力圖", "https://news.ustv.com.tw/heatmap", "台股產業熱力圖、新聞"),
            ("市場熱門族群和概念股", "https://statementdog.com/market-trend", "台股市場熱門族群熱力圖、新聞"),
        ],
        "US STOCK": [
            ("SEC (U.S. Securities and Exchange Commission)", "https://www.sec.gov/", "10-K/10-Q/8-K 官方查詢"),
            ("WiseSheets", "https://www.wisesheets.io/", "美股 Excel/Sheets 抓財報資料"),
            ...
            ("Finviz Heatmap", "https://finviz.com/map.ashx", "美股產業熱力圖"),
            ("QUIVER QUANTITATIVE", "https://www.quiverquant.com/", "Trade Like a Insider"),
        ],
        "NEWS": [
            ("yahoo!股市", "https://tw.finance.yahoo.com/?utm_source=chatgpt.com", "yahoo!股市"),
            ("股市｜聯合新聞網", "https://udn.com/news/cate/2/6645", "股市｜聯合新聞網"),
            ("美股放大鏡", "https://www.forecastock.tw/article", "美股放大鏡"),
            ("鉅亨網 Cnyes", "https://www.cnyes.com/", "台股/美股/外匯即時新聞"),
            ("CNBC World", "https://www.cnbc.com/world/", "國際財經新聞與專題"),
        ],
        "Economic Indicators": [
            ("景氣對策信號", "https://www.macromicro.me/collections/10/tw-monitoring-indicators-relative/79/tw-monitoring-indicators", "台灣歷史景氣燈號"),
            ("景氣指標查詢", "https://index.ndc.gov.tw/n/zh_tw", "台灣最新景氣燈號圖表"),
            ("全球總經成績單", "https://www.macromicro.me/macro", "全球總經成績單"),
            ("VIX 指數", "https://finance.yahoo.com/quote/%5EVIX/", "恐慌指數，反映美股市場預期波動性"),
        ]
    }
